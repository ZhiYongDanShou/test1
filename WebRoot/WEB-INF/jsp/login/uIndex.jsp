...
<!--导航条-->
<div class="width100" style="height: 45px;background: #92BD6C;margin-top: 40px;position: relative;z-index: 100;">
    <!--中间的部分-->
    <div class="width1200 center_yh relative_yh" style="height: 45px;background: #92BD6C">
        <!--列表导航-->
        <div class="left_yh Selected" style="width: 230px;height: 45px;background: #92BD6C" id="hiddenShow ">
            <!--头部的图标-->
            ...
            <!--导航展开部分-->
            <div class="downSlide" style="background: #92BD6C">
        ...
        <!--普通导航-->
        <div class="left_yh font16" id="pageNav" style="background: #92BD6C">
...
<div class="width1200 center_yh hidden_yh" style="position: relative;z-index:80;">
    <div class="example2" style="width: 1200px;height: 490px;overflow: hidden;margin-left: 230px;">
        <ul>
            <li><img src="${ctx}/resource/images/轮播图1.jpg" alt=""></li>
            <li><img src="${ctx}/resource/images/轮播图6.jpg" alt=""></li>
            <li><img src="${ctx}/resource/images/轮播图5.jpg" alt=""></li>
            <li><img src="${ctx}/resource/images/轮播图要.jpg" alt=""></li>
            <li><img src="${ctx}/resource/images/轮播图4.jpg" alt=""></li>
