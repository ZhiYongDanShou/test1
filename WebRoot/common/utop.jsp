...
<div class="width100" style="height: 25px;background: #f0f0f0;">
    <div class="width1200 center_yh font14 c_66" style="height: 25px;line-height: 25px;background: #e4f5d4">
<%--        <font class="left_yh">欢迎来到茶叶销售云平台！</font>--%>
...
<%--            <img src="${ctx}/resource/images/logo.png" alt="" style="height: 70px">--%>
                <img src="${ctx}/resource/images/logo3.png" style="height: 75px">
<%--        </a>--%>
